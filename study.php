...
<body style="background-color: #ffffff;">
  ...
  <header class="header" style="height: 62px; background-color: #0084ff; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); " >
    <h1 class="header__title" align="left" style="color: #fff; font-size: 20px; font-weight: 400;">Study Material</h1>
  ...
  <main class="main" >
      ...
      <div class="row" align="center" >
          ...
          <div class="col-xs-12 col-md-12" id="place">
              ...
              <img src="images/study2.png" class="imgstyle" >
              
              <p class="mydata">Notes, presentations, lab programs and much more, all at one place.<br><br>Starting from this semester.</p>
              <br>
              <br>
